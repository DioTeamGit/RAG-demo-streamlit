...
with streamlit_analytics.track(verbose=True, streamlit_secrets_firestore_key="firestore_key", firestore_project_name="streamlit-analytics-rag", firestore_collection_name="counts"):
