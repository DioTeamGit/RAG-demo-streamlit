...
with streamlit_analytics.track(verbose=True, firestore_key_file=st.secrets["firestore_key"], firestore_project_name="streamlit-analytics-rag", firestore_collection_name="counts"):
